...
const faviconSvg = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64">
  <defs>
    <pattern id="g" width="8" height="8" patternUnits="userSpaceOnUse"><path d="M8 0H0V8" fill="none" stroke="#1e293b" stroke-width="1"/></pattern>
    <clipPath id="r"><rect x="2" y="2" width="60" height="60" rx="13"/></clipPath>
    <filter id="glow" x="-40%" y="-40%" width="180%" height="180%"><feGaussianBlur stdDeviation="1.3" result="b"/><feMerge><feMergeNode in="b"/><feMergeNode in="SourceGraphic"/></feMerge></filter>
  </defs>
  <g clip-path="url(#r)">
    <rect x="2" y="2" width="60" height="60" fill="#09090b"/>
    <rect x="2" y="2" width="60" height="60" fill="url(#g)"/>
  </g>
  <rect x="2" y="2" width="60" height="60" rx="13" fill="none" stroke="#27272a" stroke-width="1.5"/>
  <text x="32" y="43" text-anchor="middle" font-family="ui-monospace, SFMono-Regular, Menlo, monospace" font-weight="700" font-size="28" letter-spacing="1.5"><tspan fill="#09090b" stroke="#52525b" stroke-width="1.1">V</tspan><tspan fill="#22d3ee" filter="url(#glow)">2</tspan><tspan fill="#09090b" stroke="#52525b" stroke-width="1.1">X</tspan></text>
</svg>`;
