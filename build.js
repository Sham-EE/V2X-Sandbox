...
const faviconSvg = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64">
  <defs>
    <pattern id="g" width="10" height="10" patternUnits="userSpaceOnUse"><path d="M10 0H0V10" fill="none" stroke="#67e8f9" stroke-opacity="0.32" stroke-width="1.4"/></pattern>
  ...
  <text x="32" y="43" text-anchor="middle" font-family="ui-monospace, SFMono-Regular, Menlo, monospace" font-weight="700" font-size="28" letter-spacing="1.5"><tspan fill="#09090b" stroke="#ffffff" stroke-width="2" paint-order="stroke">V</tspan><tspan fill="#22d3ee" filter="url(#glow)">2</tspan><tspan fill="#09090b" stroke="#ffffff" stroke-width="2" paint-order="stroke">X</tspan></text>
</svg>`;
